...
#else
  // JNIEnv is pointer to the struct JNINativeInterface
...
struct JNINativeInterface_ {
    ...
    // Here you can see the design, pointer-to-pointer because "JNIEnv" is a pointer, 
    // and there is another pointer too, the "*env"
